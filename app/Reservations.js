...
import { View, Text, useEffect, TextInput, Button, StyleSheet } from 'react-native';
...
import { locationId } from "../routes/external_api/reservations";
...
const ReservationPage = () => {
  ...
  useEffect = () => {
    const TRIPADVISOR_API_KEY = "340FBEE860254364A316B2696C903E70"
    const TRIPADVISOR_API_URL = "https//api.content.tripadvisor.com/api/v1/location/location_id"
    const getReservation = async () => {
      try {
        const response = await fetch(`${TRIPADVISOR_API_URL}?access_key=${TRIPADVISOR_API_KEY}&query=${locationId}&units=f`)
